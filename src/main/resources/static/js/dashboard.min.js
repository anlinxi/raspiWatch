...
$(document).ready(function () {
    ...
    var chartCache = Highcharts.chart("container-cache", Highcharts.merge(gaugeOptions, {
        ...
        series: [{
            name: "CACHE",
            data: [0],
            dataLabels: {format: '<div style="text-align:center"><span style="font-size:12px;color:' + ((Highcharts.theme && Highcharts.theme.contrastTextColor) || "black") + '">{y:.1f}</span><br/>' + '<span style="font-size:10px;color:silver">MB</span></div>'},
            tooltip: {valueSuffix: " MB"}
        }]
    }));
    ...
    var chartDisk = Highcharts.chart("container-disk", Highcharts.merge(gaugeOptions, {
        ...
        series: [{
            name: "DISK",
            data: [0],
            dataLabels: {format: '<div style="text-align:center"><span style="font-size:12px;color:' + ((Highcharts.theme && Highcharts.theme.contrastTextColor) || "black") + '">{y:.1f}</span><br/>' + '<span style="font-size:10px;color:silver">GB</span></div>'},
    ...
    for (i = 0; i < init_vals.net.count; i++) {
        var chartNetInterface = Highcharts.chart("container-net-interface-" + (i + 1), {
            ...
            yAxis: {title: {text: "", style: {fontWeight: "normal"}}},
            series: [{name: "IN", data: [0], color: "#093AC9", marker: {enabled: false}}, {
                name: "OUT",
                data: [0],
                color: "#3CCB3E",
